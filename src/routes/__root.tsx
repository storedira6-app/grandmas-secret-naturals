...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Natural beauty rituals, grandma's recipes and remedies — 100% natural.",
      },
      { property: "og:title", content: "سر الجدة | Grandma's Secret" },
    ...
    links: [
      ...
      { rel: "preconnect", href: "https://logo.clearbit.com", crossOrigin: "anonymous" },
    ...
    scripts: [
      ...
      {
        async: true,
        src: "https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5469603058026078",
