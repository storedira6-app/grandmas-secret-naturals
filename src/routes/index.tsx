        ...
        <div className="mt-auto space-y-3 pt-8">
          ...
          >
            ...
            <span className="min-w-0">
              <span className="block truncate text-sm font-bold">{t("skinTitle")}</span>
              <span className="block truncate text-[11px] text-muted-foreground">{t("skinSub")}</span>
            </span>
          </Link>

          <Link
            to={user ? "/app/skin" : "/app/chat"}
